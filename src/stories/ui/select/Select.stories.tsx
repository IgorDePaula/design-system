...
export default {
  ...
  argTypes: {
    ...
    required: {
      description:
        "Boolean para indicar quando o campo é um recurso  obrigatório do formulário",
      defaultValue: false,
      options: [true, false],
      table: {
        type: [true, false],
    ...
    isSubmiting: {
      description:
        "Boolean para indicar quando o campo e o formulario foram submetidos, para validar e" +
        " recuperar seu valor",
      defaultValue: false,
      options: [true, false],
      table: {
    ...
    getError: {
      description:
        "Funcao para indicar se o campo tem erro de validacao ou nao",
    },
  },
  parameters: {
    layout: "centered",
