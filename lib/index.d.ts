...
export type { AvatarType, BadgetType, ButtonType, LabelType, MenuType, MenuItemType, ThemeType, TableType, DataTableType, SwitcherType, InputType };
export { Avatar, Badget, Button, Table, Label, Link, Loading, Option, Input, Switcher, formatPrice, classNames };
