...
const UserMenu = ({ variant }) => {
    ...
    return (React.createElement("div", { className: "contents" },
        React.createElement("div", { "data-testid": "user-menu-wrapper-icon", className: "flex items-center place-content-center mr-4 w-10 h-10 rounded-full cursor-pointer", onClick: () => setShowDropdown((prevState) => !prevState) },
            React.createElement(AvatarIcon, { width: "30", height: "30", variant: variant })),
        React.createElement("div", { tabIndex: 0, className: `${showDropdown ? "block" : "hidden"} absolute mt-10 z-10 w-44 bg-white-bg rounded-lg divide-y divide-gray-400 shadow`, onBlur: () => setShowDropdown(false) },
